...
export default function NavigationMenu({ mobileMenuOpen, isLoggedIn, setIsLoggedIn }: NavigationMenuProps) {
  return (
    <nav
      className={cn(
    ...
    >
      ...
      <div className="md:hidden flex flex-col space-y-2 pt-2 border-t mt-2">
        {!isLoggedIn && (
          <>
            <Link href="#" className="block py-1" onClick={() => setIsLoggedIn(true)}>
              Login
            </Link>
